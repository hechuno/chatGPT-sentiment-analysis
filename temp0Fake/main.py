...
df1 = pd.read_csv("GEN_BuzzFeed_fake_news_temp0_ite1.csv")
df2 = pd.read_csv("GEN_BuzzFeed_fake_news_temp0_ite2.csv")
df3 = pd.read_csv("GEN_BuzzFeed_fake_news_temp0_ite3.csv")
df4 = pd.read_csv("GEN_BuzzFeed_fake_news_temp0_ite4.csv")
df5 = pd.read_csv("GEN_BuzzFeed_fake_news_temp0_ite5.csv")
...
df.to_csv("BuzzFeed_fake_news_with_averages_temp0.csv", index=False)
