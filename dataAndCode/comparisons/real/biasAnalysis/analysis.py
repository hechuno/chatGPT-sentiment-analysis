...
dfleft = pd.read_csv("leftWingReal.csv", encoding="ISO-8859-1")
...
dfright = pd.read_csv("rightWingReal.csv", encoding="ISO-8859-1")
...
def plot_boxplot_left():
    ...
    plt.title('Boxplot of Sentiment per Word Real News Left Bias (Different Temperatures)', fontsize=16)
...
def plot_boxplot_right():
    ...
    plt.title('Boxplot of Sentiment per Word Real News Right Bias (Different Temperatures)', fontsize=16)
    plt.xlabel('Temperature', fontsize=14)
    plt.ylabel('Sentiment Value per Word', fontsize=14)
    plt.show()
