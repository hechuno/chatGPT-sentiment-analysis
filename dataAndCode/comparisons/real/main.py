...
df1 = pd.read_csv("BuzzFeed_real_news_with_averages_temp0.csv")
df2 = pd.read_csv("BuzzFeed_real_news_with_averages_temp0.5.csv")
df3 = pd.read_csv("BuzzFeed_real_news_with_averages_temp1.csv")
...
#Removing articles too small or higher than 1200 since chatGPT struggles to create content with more than 1000 words.
...
df.to_csv("BuzzFeed_real_news_grouped_temp_data2.csv", index=False)
